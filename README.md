...
│   └── seed.py               Demo: the Northbridge demo scenario (7 agents)
├── frontend/
│   └── src/
...
# 5. Load demo (7 Northbridge stakeholders, Northbridge City scenario)
...
| `POST` | `/api/projects/seed-demo` | Load Northbridge demo project |
...
| **v0.14+** | Backlog | See [GitHub Issues →](https://github.com/ArtemisAI/A2A-WarGames/issues) for current backlog (6 open issues) |

All tracked work and backlog: [GitHub Issues →](https://github.com/ArtemisAI/A2A-WarGames/issues)
